  ...
  <ul class="navbar-nav ml-auto align-items-center">
    ...
    <li class="nav-item dropdown no-arrow" >
      <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" 
        ...
        @php
          $user = Auth::guard('cgraeagent')->user();
        @endphp
        <div class="profile-picture">
          <img class="img-profile rounded-circle" src="{{ asset('assets/images/profiles/cgrae.jpg') }}" alt="Profile Image">
      </div>
        <span class="ml-2 d-none d-lg-inline text-black small" style="color: white !important;"><strong>Agence : {{ $user->communeM }}</strong></span>
      </a>
      <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
        ...
        <a class="dropdown-item" href="{{ route('cgraeagent.logout') }}">
