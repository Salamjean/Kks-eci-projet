...
<body>
    <header>
        <div class="logo_g">
            <div class="logo">
                <img src="assets/images/profiles/cgrae.jpg" class="logo2" alt="Logo">
                <img src="assets/images/profiles/gouv_ci.png" class="logo1" alt="Logo">
            </div>
        </div>
        <br><br><br><br><br><br>
        <h1 class="tete">Caisse générale de retraite des agents de l'État</h1>
    </header>
    <main>
        <div class="InfoNor">
        ...
        <div class="agent" >
            <div class="column">
                <p><strong>Vous avez été reçu par :</strong> {{ $cgraeagent->name .' '. $cgraeagent->prenom }}</p>
                <p><small>Qui réside à :</small> {{ $cgraeagent->commune }}</p>
            </div>
            <div class="column">
                <p><small>Joignable au :</small> {{ $cgraeagent->contact }}</p>
                <p><strong>Travaillant à la  :</strong> Caisse générale de retraite des agents de l'État </p>
            </div>
            <div class="full-width">
                <p><strong>Siège de :</strong> {{ $cgraeagent->communeM }}</p>
            </div>
        </div>
        <div class="signature">
