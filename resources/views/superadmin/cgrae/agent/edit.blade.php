...
<div class="signup-container">
  <h6 style="color: green">Modifier les informations de l'agent {{ $agent->name . ' ' . $agent->prenom}}</h6>
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST"  action="{{ route('cgraeagent.update', $agent->id) }}" novalidate>
        @csrf
        @method('PUT')
