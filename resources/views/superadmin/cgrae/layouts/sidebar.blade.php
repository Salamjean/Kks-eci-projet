<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('cgraes.dashboard') }}"  style="background-color: rgb(7, 160, 7)">
    <div>
  ...
  <li class="nav-item active">
    <a class="nav-link" href="{{ route('cgraes.dashboard') }}">
