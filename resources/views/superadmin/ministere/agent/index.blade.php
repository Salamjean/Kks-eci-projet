            ...
            <table class="table align-items-center table-flush" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr style="font-size: 12px">
                        ...
                        <td>{{ $agent->commune }}</td>
                        <td>
                            <form action="{{ route('ministereagent.edit', $agent->id) }}" method="GET">
                                @csrf
                                <button style="margin-left:50%" type="submit" ><a href="{{ route('ministereagent.edit', $agent->id) }}" class="edit"><i class="fas fa-edit"></i></a></button>
                            </form>
                        </td>
                        <td>
                        <form id="deleteForm{{ $agent->id }}" action="{{ route('ministereagent.archive', $agent->id) }}" method="POST" style="display: flex; justify-content:center; align-items:center">
                            @csrf
                            @method('DELETE')
