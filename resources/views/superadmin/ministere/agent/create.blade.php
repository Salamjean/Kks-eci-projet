...
<div class="signup-container">
  <h6 style="color: black">Inscrire un agent du ministère de la santé du siège {{ Auth::guard('ministere')->user()->siege }}</h6>
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('ministereagent.store') }}" novalidate>
        @csrf
        @method('POST')
