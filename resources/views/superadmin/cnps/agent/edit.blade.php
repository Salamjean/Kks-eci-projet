...
<div class="signup-container">
  <h6 style="color: orange">Modifier les informations de l'agent {{ $agent->name . ' ' . $agent->prenom}}</h6>
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST"  action="{{ route('cnpsagent.update', $agent->id) }}" novalidate>
        @csrf
        @method('PUT')
