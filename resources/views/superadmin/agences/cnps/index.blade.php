      ...
      <div class="col-lg-12">
        <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold " style="color:orange">Informations sur les agences</h6>
          </div>
            ...
            <table class="table align-items-center table-flush" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr style="font-size: 12px">
                        ...
                        <td>
                            <form action="{{ route('cnpsagences.edit', $agence->id) }}" method="GET">
                                @csrf
                                <button style="margin-left:50%" type="submit" ><a href="{{ route('cnpsagences.edit', $agence->id) }}" class="edit"><i class="fas fa-edit"></i></a></button>
                            </form>
                        </td>
                        <td>
                        <form id="deleteForm{{ $agence->id }}" action="{{ route('cnpsagences.archive', $agence->id) }}" method="POST" style="display: flex; justify-content:center; align-items:center">
                            @csrf
                            @method('DELETE')
