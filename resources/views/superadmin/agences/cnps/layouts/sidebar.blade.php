<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('cnpsagences.dashboard') }}"  style="background-color: rgba(255, 166, 0, 0.772)">
    <div>
  ...
  <li class="nav-item active">
    <a class="nav-link" href="{{ route('cnpsagences.dashboard') }}">
  ...
  <li class="nav-item">
    ...
    <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{ route('cnpsagences.indexdashboard') }}">Extrait-Décès</a>
      </div>
    </div>
  </li>
