...
<div class="signup-container">
  <h6 style="color: orange">Modifier les informations de l'agence {{ $agence->agence_name}}</h6>
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST"  action="{{ route('cnpsagences.update', $agence->id) }}" novalidate>
        @csrf
        @method('PUT')
