...
<div class="signup-container">
  <h6 style="color:green">Inscrire une agence de la CGRAE de {{ Auth::guard('cgrae')->user()->siege }}</h6>
  <div class="ms-panel-body">
    <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('cgraeagences.store') }}" novalidate>
        @csrf
        @method('POST')
        ...
        <button class="btn btn-primary" type="submit" style="background-color: green; color: white;">Créer le compte</button>
    </form>
  </div>
</div>
<script>
