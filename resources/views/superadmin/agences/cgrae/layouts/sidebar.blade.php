<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" >
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('cnps.dashboard') }}"  style="background-color: rgb(1, 110, 1)">
    <div>
  ...
  <li class="nav-item active">
    <a class="nav-link" href="{{ route('cgraeagences.dashboard') }}">
  ...
  <li class="nav-item" style="font-size: 15px; text-align:center">
    ...
    <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Agent-Cgrae</h6>
  ...
  <li class="nav-item">
    ...
    <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="{{ route('cgraeagences.indexdashboard') }}">Extrait-Décès</a>
      </div>
    </div>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="{{ route('cgraeagences.historique') }}">
