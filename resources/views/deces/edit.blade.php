    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
           ...
           <div class=" px-6 py-5" style="background-color: #6777ef">
            ...
            <!-- Form Container -->
            <div class="p-6">
                <form action="{{ route('deces.updateEtat', $deces->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('POST')
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input type="text" id="nomDefunt" 
                                   ...
                                   value="{{ $deces->user ? $deces->user->name .' '.$deces->user->prenom : 'Demandeur inconnu' }}" 
                                   disabled>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="etat" id="etat" 
                            ...
                            @foreach($etats as $etat)
                                <option value="{{ $etat }}" {{ $deces->etat == $etat ? 'selected' : '' }} class="py-2">
                                    {{ ucfirst($etat) }}
                                </option>
                            @endforeach
                        </select>
