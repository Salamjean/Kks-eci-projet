...
<div class="ms-content-wrapper">
  @php
  $profileImage = Auth::guard('sous_admin')->user()->profile_picture
      ? asset('storage/' . Auth::guard('sous_admin')->user()->profile_picture)
      : (Auth::guard('sous_admin')->user()->sexe == 'Homme'
          ? asset('assets/images/profiles/user_homme.png')
          : (Auth::guard('sous_admin')->user()->sexe == 'Femme'
...
@endphp
    ...
    padding: 1.5rem;">>
        ...
        <div class="ms-profile-user-info">
          <h3 class="ms-profile-username text-white">{{ Auth::guard('sous_admin')->user()->name }} {{ Auth::guard('sous_admin')->user()->prenom }}</h3>
          <h6 class="ms-profile-role text-white text-center">{{ Auth::guard('sous_admin')->user()->fonction }}</h6>
        </div>
      </div>
    ...
    <div class="col-xl-12 col-md-12">
      <div class="ms-panel">
        ...
        <div class="ms-panel-body">
          <form method="POST" action="{{ route('sous_admin.profilupdate') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="validationCustom010" placeholder="Modifiez votre nom..." name="name" value="{{ $sousAdmin->name }}">
                  @error('name')
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="validationCustom020" placeholder="Modifiez votre prénom..." name="prenom" value="{{ $sousAdmin->prenom }} ">
                    @error('prenom')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
            ...
            <div class="form-row">
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  <input type="email" class="form-control" id="validationCustom050" placeholder="Modifiez votre email..."  name="email" value="{{ $sousAdmin->email }}" >
                  @error('email')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-md-6 mb-2 ">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="validationCustom030" placeholder="Modifiez votre numéro de téléphone..." name="contact" value="{{ $sousAdmin->contact }}">
                  @error('contact')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-md-6 mb-3 text-center">
                  ...
                  <div class="mt-4">
                      @if ($sousAdmin->profile_picture)
                          ...
                          <img src="{{ asset('storage/' . $sousAdmin->profile_picture) }}" alt="Profile Image" class="mt-2" style="width: 100px; height: 100px; border-radius: 50%;">
                      @else
