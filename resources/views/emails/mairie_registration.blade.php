...
<body>
    <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td>
                <h1>Votre Mairie a été enregistrée dans notre base de données</h1>
                ...
                <p><a href="{{ url('/validate-mairie-account/' . $email) }}" style="background-color:#4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; cursor: pointer;">Valider mon compte</a></p>
