    ...
    <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('caisse.store') }}" novalidate>
        ...
        <div class="form-row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="validationCustom001" placeholder="Entrez le nom du caissier" >
                @error('name')
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="prenom" id="validationCustom002" placeholder="Entrez le prénom du caissier" >
                @error('prenom')
                <span style="color: red">{{ $message }}</span>
                @enderror
            </div>
