...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2"></i>Liste des agents du services financier de votre mairie</h1>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-file-contract me-2"></i>Agents financier de votre mairie  </h6>
            ...
            <tbody>
               @forelse ($caisses as $caisse)
                    <tr style="font-size: 12px">
                        ...
                        <td>
                            <form action="{{ route('caisse.edit', $caisse->id) }}" method="GET">
                                @csrf
                                <button style="margin-left:50%" type="submit" ><a href="{{ route('caisse.edit', $caisse->id) }}" class="edit"><i class="fas fa-edit"></i></a></button>
                            </form>
                        </td>
                        <td>
                        <form action="{{ route('caisse.delete', $caisse->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet caisse ?');" 
                            style="display: flex; justify-content:center; align-items:center">
                            @csrf
                            @method('DELETE')
                                <button type="button" class="delete" 
                                onclick="confirmDelete('{{ route('caisse.delete', $caisse->id) }}')">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center">Aucun caissier inscrire</td>
                    </tr>
                    @endforelse
            </tbody>
          </table>
