    ...
    <form class="needs-validation" method="POST" enctype="multipart/form-data" action="{{ route('livraison.store') }}" novalidate>
        ...
        <div class="form-row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="name" id="validationCustom001" placeholder="Entrez le nom du livreur" >
                @error('name')
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="prenom" id="validationCustom002" placeholder="Entrez le prénom du livreur" >
                @error('prenom')
                <span style="color: red">{{ $message }}</span>
                @enderror
            </div>
