...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2"></i>Liste des livreurs de votre mairie</h1>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-file-contract me-2"></i>Livreurs de votre mairie  </h6>
            ...
            <tbody>
               @forelse ($livraisons as $livraison)
                    <tr style="font-size: 12px">
                        ...
                        <td>
                            <form action="{{ route('livraison.edit', $livraison->id) }}" method="GET">
                                @csrf
                                <button style="margin-left:50%" type="submit" ><a href="{{ route('livraison.edit', $livraison->id) }}" class="edit"><i class="fas fa-edit"></i></a></button>
                            </form>
                        </td>
                        <td>
                        <form action="{{ route('livraison.delete', $livraison->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet livreur ?');" 
