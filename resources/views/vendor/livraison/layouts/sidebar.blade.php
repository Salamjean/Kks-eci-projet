<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" style="background-color: #f97316">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link  active" href="{{ route('livraison.dashboard') }}">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="{{ route('livraison.livraisonnoneffectuer') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1 text-white">Livraison non effectuée</span>
        </a>
      </li>
      <li class="nav-item">
