    ...
    <form class="needs-validation" method="POST"  action="{{ route('ajoint.update', $ajoint->id) }}" novalidate>
        ...
        <div class="form-row mb-3">
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" name="email" id="validationCustom003" value="{{ $ajoint->email }}" >
               
            </div>

            <div class="col-md-6">
                <label for="validationCustom004" class="form-label">Contact</label>
                <input type="text" class="form-control" name="contact" id="validationCustom004" value="{{ $ajoint->contact }}" >
            </div>
        </div>
        ...
        <div class="form-row mb-3">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" name="commune" id="validationCustom005" value="{{ $ajoint->commune }}" >
