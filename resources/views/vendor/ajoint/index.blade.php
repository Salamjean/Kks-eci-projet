...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2"></i>Liste des huissiers de votre mairie</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('vendor.dashboard') }}"><i class="fas fa-home"></i> Accueil</a></li>
      <li class="breadcrumb-item active">Huissiers</li>
    </ol>
  </div>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-file-contract me-2"></i>Huissiers de votre mairie  </h6>
                    ...
                    <tr style="font-size: 12px" class="text-center">
                        ...
                        <form action="{{ route('ajoint.delete', $ajoint->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet ajoint ?');" 
                            ...
                            <button type="button" class="delete" 
                                onclick="confirmDelete('{{ route('ajoint.delete', $ajoint->id) }}')">
