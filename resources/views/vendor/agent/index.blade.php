...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="page-title"><i class="fas fa-users me-2"></i>Liste des agents de votre mairie</h1>
    <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="m-0 font-weight-bold"><i class="fas fa-file-contract me-2"></i>Agents de votre mairie  </h6>
                    ...
                    <tr style="font-size: 12px" class="text-center">
                        ...
                        <form action="{{ route('agent.delete', $agent->id) }}" method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cet agent ?');" 
                            ...
                            @method('DELETE')
                                ...
                                onclick="confirmDelete('{{ route('agent.delete', $agent->id) }}')">
