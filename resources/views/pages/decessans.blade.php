      ...
      <div class="request-card bg-white rounded-lg shadow p-4 p-md-5" style="
        ...
        <div class="request-header text-center mb-5">
          <h1 class="request-title mb-3" style="font-size: 2.8rem; font-weight: 700; color: #333; line-height: 1.2;">
            Extrait de Décès <br>Simple ou Intégral
          </h1>
        </div>
        ...
        <div class="request-description mb-5">
          <p style="font-size: 1.15rem; line-height: 1.7; color: #333; text-align: justify;">
            L'acte de décès peut donner lieu à la délivrance de 2 documents différents : 
            ...
            (nom, prénoms, date et lieu de décès), des informations sur ses parents 
        ...
        <div class="request-procedure mb-5">
          ...
          <ul class="requirements-list pl-0" style="list-style: none;">
            <li class="mb-3 d-flex align-items-start">
              ...
              <span style="flex: 1; font-weight: 500; font-size: 1.1rem;">Nom et prénoms du défunt</span>
            </li>
            <li class="mb-3 d-flex align-items-start">
              <span class="badge badge-success mr-3 p-2" style="
                min-width: 32px; 
            ...
            <li class="mb-3 d-flex align-items-start">
              ...
              <span style="flex: 1; font-weight: 500; font-size: 1.1rem;">Date de registre</span>
            </li>
            <li class="mb-3 d-flex align-items-start">
              <span class="badge badge-success mr-3 p-2" style="
                min-width: 32px; 
              ...
              <span style="flex: 1; font-weight: 500; font-size: 1.1rem;">Certificat médical de décès</span>
            </li>
