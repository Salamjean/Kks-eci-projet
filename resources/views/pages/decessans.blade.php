        ...
        <div class="row">
          <div class="col-lg-10 offset-lg-1 col-12">
            <div class="error-inner">
              <br><br><br>
              <h1 class="responsive-title">Extrait de Décès <br> Simple ou <br>Intégral</h1>
              <p style="color:black; font-size:22px">Acte de décès peut donner lieu à la délivrance de 2 documents différents : la copie intégrale, l'extrait simple.
              ...
              <p style="color:black; font-size:22px">Pour une demande d'extrait de décès, <br>
                il faut :
              <li style="font-size:22px">Le nom et prénoms du défunt</li>
              <li style="font-size:22px">Numéro de registre</li>
              <li style="font-size:22px">Date de registre</li>
