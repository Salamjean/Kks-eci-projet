...
class SendEmailToCgraeAgentAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Votre CGRAE Agent a été enregistré est enregistrer dans la base de données de E-CI')
                    ...
                    ->action('Cliquez ici', url('/validate-cgrae-agent-account' . '/' .$this->email))
