...
class SendEmailToAgenceCgraeAfterRegistrationNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Votre Agence Cgrae a été enregistré est enregistrer dans la base de données de E-CI')
                    ...
                    ->action('Cliquez ici', url('/validate-cgrae-agence-account' . '/' .$this->email))
