...
class SendEmailToCaisseAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Caissié est enregistrer dans votre maire')
                    ...
                    ->action('Cliquez ici', url('/validate-caisse-account' . '/' .$this->email))
