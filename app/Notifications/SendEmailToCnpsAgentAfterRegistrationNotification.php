...
class SendEmailToCnpsAgentAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Votre CNPS Agent a été enregistré est enregistrer dans la base de données de E-CI')
                    ...
                    ->action('Cliquez ici', url('/validate-cnps-agent-account' . '/' .$this->email))
