...
class SendEmailToAgenceCnpsAfterRegistrationNotification extends Notification
{
    ...
    public function __construct($codeToSend, $sendToemail)
    {
        ...
        $this->logoUrl = asset('assets/images/profiles/E-ci-logo.png'); // URL du logo ici
    }
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('E-CI : Votre Agence Cnps est enrégistré dans le siège CNPS')
            ->from('no-reply@example.com', 'E-CI')
            ->view('emails.agence_cnps_registration', [
                'code' => $this->code,
                'email' => $this->email,
