...
class SendEmailToMinistereAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Le ministere de la santé a été enregistré est enregistrer dans la base de données de E-CI')
                    ...
                    ->action('Cliquez ici', url('/validate-ministere-account' . '/' .$this->email))
