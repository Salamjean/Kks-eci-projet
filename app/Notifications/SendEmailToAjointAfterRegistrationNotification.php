...
class SendEmailToAjointAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Ajoint au maire est enregistrer dans votre maire')
                    ...
                    ->action('Cliquez ici', url('/validate-ajoint-account' . '/' .$this->email))
