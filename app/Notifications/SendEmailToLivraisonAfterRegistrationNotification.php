...
class SendEmailToLivraisonAfterRegistrationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('E-CI : Livreur vous êtes enregistré auprès de votre mairie') // Sujet mis à jour
            ->from('contact@edemarchee-ci.com', 'E-CI')
            ->view('emails.livraison_registration', [
                'code' => $this->code,
                'email' => $this->email,
